...
console.log(greetUser('ishakrishangi'))
...
console.log(canWeDeliver(45204))
...
console.log(canWeDeliverTwo(45204))
...
*/
//i think this a a string method
//CODE HERE
const newTenPercent = (deals[0].title).replace('15', 
'10')
console.log(newTenPercent)
...
//CODE HERE
const aprilDeal = (deals[1].desc).replace('March', 
'April').trim()
console.log(aprilDeal)